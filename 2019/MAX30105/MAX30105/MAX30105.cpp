/***************************************************
  ...
  It should also work with the MAX30102.   However, the MAX30102 does not 
  have a Green LED. 
...
boolean MAX30105::begin(TwoWire &wirePort, uint32_t i2cSpeed, uint8_t i2caddr) {
  ...
  _id = readPartID();
  if ((_id != MAX_30102_EXPECTEDPARTID) && (_id != MAX_30105_EXPECTEDPARTID)) {
...
uint8_t MAX30105::readRevisionID() {
  return readRegister8(_i2caddr, MAX30105_REVISIONID);
}
