/***************************************************
  ...
  It should also work with the MAX30102. However, the MAX30102 does not have a Green LED. It will also work for MAX30105 sensor.
...
boolean MAX30105::begin(TwoWire &wirePort, uint32_t i2cSpeed, uint8_t i2caddr) {
  ...
  if ((id != MAX_30102_EXPECTEDPARTID) && (id != MAX_30105_EXPECTEDPARTID)) {
